...
Faction.create!(name: "Nilfgaardian Empire", description: "")
Faction.create!(name: "Monster", description: "")
Faction.create!(name: "Northern Realms", description: "")
Faction.create!(name: "Scoia'tael", description: "")
